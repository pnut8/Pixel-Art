...
export function Grid() {
  ...
  return (
    <>
      <h1 className="text-7xl py-4 text-center">8-Bit Art</h1>
      <div className="grid bg-base-300 p-10 mx-20 justify-center rounded-lg ring-2 overflow-hidden grid-cols-[0.9fr_1.6fr_0.9fr] gap-4">
